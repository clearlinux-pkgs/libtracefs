...
Version  : 1.6.3
Release  : 19
URL      : https://git.kernel.org/pub/scm/libs/libtrace/libtracefs.git/snapshot/libtracefs-1.6.3.tar.gz
Source0  : https://git.kernel.org/pub/scm/libs/libtrace/libtracefs.git/snapshot/libtracefs-1.6.3.tar.gz
...
%prep
%setup -q -n libtracefs-1.6.3
cd %{_builddir}/libtracefs-1.6.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671052147
