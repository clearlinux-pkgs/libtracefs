...
Source0  : https://git.kernel.org/pub/scm/libs/libtrace/libtracefs.git/snapshot/libtracefs-1.8.2.tar.gz
Summary  : No detailed summary available
Group    : Development/Tools
License  : LGPL-2.0
Requires: libtracefs-bin = %{version}-%{release}
Requires: libtracefs-data = %{version}-%{release}
...
%package data
Summary: data components for the libtracefs package.
Group: Data

%description data
data components for the libtracefs package.
...
%prep
%setup -q -n libtracefs-1.8.2
cd %{_builddir}/libtracefs-1.8.2
pushd ..
cp -a libtracefs-1.8.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1745270354
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libtracefs.so.1.8.2
/usr/lib64/libtracefs.so.1
/usr/lib64/libtracefs.so.1.8.2
