...
Source0  : https://git.kernel.org/pub/scm/libs/libtrace/libtracefs.git/snapshot/libtracefs-1.5.0.tar.gz
...
%prep
%setup -q -n libtracefs-1.5.0
cd %{_builddir}/libtracefs-1.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1663941498
